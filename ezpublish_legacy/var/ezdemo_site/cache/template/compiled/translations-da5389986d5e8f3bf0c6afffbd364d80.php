...
$oldSetArray_be167b2b623bd18c84fc2bfd29de3ad2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/ezpublish/index.php/admin_site/content/translation">
...
<tr>
    <th class="tight"><img src="/ezpublish/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Language</th>
    <th>Locale</th>
...
$text .= '><img src="/ezpublish/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_be167b2b623bd18c84fc2bfd29de3ad2;
$tpl->Level--;
?>
