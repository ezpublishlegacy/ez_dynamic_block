...
$oldSetArray_40a780173359639960576e8b28439ae0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="ordering" method="post" action="/ezpublish/index.php/admin_site/content/action">
...
$setArray = $oldSetArray_40a780173359639960576e8b28439ae0;
$tpl->Level--;
?>
