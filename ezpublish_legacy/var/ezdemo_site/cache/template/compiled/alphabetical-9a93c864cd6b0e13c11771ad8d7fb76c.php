...
$oldSetArray_127092e9b168eb96b6aa2c203a4ca91c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    ';
$oldRestoreIncludeArray_63074e2e13301e86fb42e986d2ef91f8 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_63074e2e13301e86fb42e986d2ef91f8;
...
$setArray = $oldSetArray_127092e9b168eb96b6aa2c203a4ca91c;
$tpl->Level--;
?>
