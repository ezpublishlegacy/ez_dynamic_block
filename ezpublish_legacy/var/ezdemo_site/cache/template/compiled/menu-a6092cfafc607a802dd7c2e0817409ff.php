...
$oldSetArray_016ea44c10845ac51886e2242c09c1d9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_6f494d1d017363273c2cd4fe31266e48 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-f1ad466b425a17e04f83caab87797844.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-f1ad466b425a17e04f83caab87797844.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_6f494d1d017363273c2cd4fe31266e48;
...
$text .= ' title="View and manage the contents of the trash bin."><img src="/ezpublish/design/admin/images/trash-icon-16x16.gif" width="16" height="16" alt="Trash" />&nbsp;<span>Trash</span></a>
</div>';
}
unset( $if_cond );
// if ends
...
';
$oldRestoreIncludeArray_49341258a25d3a7b2ccb872861455260 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/ini_menu-550871c619be4d7b483ef4e06c68f75c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/ini_menu-550871c619be4d7b483ef4e06c68f75c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_49341258a25d3a7b2ccb872861455260;
...
$setArray = $oldSetArray_016ea44c10845ac51886e2242c09c1d9;
$tpl->Level--;
?>
