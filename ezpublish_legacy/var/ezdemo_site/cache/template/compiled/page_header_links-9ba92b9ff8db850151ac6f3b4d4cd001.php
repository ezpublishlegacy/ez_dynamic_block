...
$oldSetArray_b02fb665eafafd52adfeb8873a7d2122 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/ezpublish/eng/shop/basket" title="Shopping basket">Shopping basket</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/ezpublish/eng/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/ezpublish/eng/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/ezpublish/eng/user/register" title="Register">Register</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/ezpublish/eng/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/ezpublish/eng/user/forgotpassword" class="forgot-password">Forgot your password?</a>
...
$setArray = $oldSetArray_b02fb665eafafd52adfeb8873a7d2122;
$tpl->Level--;
?>
