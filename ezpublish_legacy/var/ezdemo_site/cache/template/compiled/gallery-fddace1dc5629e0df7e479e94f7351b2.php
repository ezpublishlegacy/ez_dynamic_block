...
$oldSetArray_2be56b9c33bf4351fae6d13534baa63b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-9cf1881dd42f17b7eb6bc9bfa4c096f7.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-9cf1881dd42f17b7eb6bc9bfa4c096f7.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_viewer-4ca3468dea35283684deffdd7fcaf943.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_viewer-4ca3468dea35283684deffdd7fcaf943.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$text .= '        </div>
        <div class="gallery-navigator">
            ...
            <img src="/ezpublish/extension/ezdemo/design/ezdemo/images/fg-selected.png" alt="Selected indicator" class="cursor" />
            <ul class="images">
            ';
// foreach begins
$skipDelimiter = true;
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-a7d9f744bdb796688988c171fa535535.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-a7d9f744bdb796688988c171fa535535.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_item-3dd369c87f366a2f28277e59efbec98c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_item-3dd369c87f366a2f28277e59efbec98c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$setArray = $oldSetArray_2be56b9c33bf4351fae6d13534baa63b;
$tpl->Level--;
?>
