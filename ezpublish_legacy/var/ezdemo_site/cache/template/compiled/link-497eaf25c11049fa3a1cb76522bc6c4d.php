...
$oldSetArray_3f97348075c5e5b533bf4953330a0182 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/ezpublish/eng" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Index" href="/ezpublish/eng" />
<link rel="Top"  href="/ezpublish/eng" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/ezpublish/eng/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Copyright" href="/ezpublish/eng/ezinfo/copyright" />
<link rel="Author" href="/ezpublish/eng/ezinfo/about" />
<link rel="Alternate" type="application/rss+xml" title="RSS" href="/ezpublish/eng/rss/feed/my_feed" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_3f97348075c5e5b533bf4953330a0182;
$tpl->Level--;
?>
