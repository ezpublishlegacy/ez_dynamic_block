<?php
// URI:       design:content/datatype/edit/ezsrrating.tpl
// Filename:  extension/ezstarrating/design/standard/templates/content/datatype/edit/ezsrrating.tpl
// Timestamp: 1404662618 (Sun Jul 6 9:03:38 PDT 2014)
$oldSetArray_7b09bd28ace3d336162dbacf53eff62b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( $tpl->hasVariable( 'rating', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'rating' is already defined.", array (
  0 => 
  array (
    0 => 9,
    1 => 4,
  ...
  2 => 'extension/ezstarrating/design/standard/templates/content/datatype/edit/ezsrrating.tpl',
) );
    $tpl->setVariable( 'rating', $var, $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'rating', $var, $rootNamespace );
}
...
unset( $var8 );
unset( $var8 );
$var8 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'rating', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['rating'] : null;
$var9 = compiledFetchAttribute( $var8, 'rating_average' );
unset( $var8 );
$var8 = $var9;
...
unset( $var8 );
$var8 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'rating', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['rating'] : null;
$var9 = compiledFetchAttribute( $var8, 'rating_count' );
unset( $var8 );
$var8 = $var9;
if (! isset( $var8 ) ) $var8 = NULL;
while ( is_object( $var8 ) and method_exists( $var8, 'templateValue' ) )
...
while ( is_object( $var7 ) and method_exists( $var7, 'templateValue' ) )
    $var7 = $var7->templateValue();
$var3 = ( '<span id="ezsr_total_' . $var5 . '">' . $var7 . '</span>' );
unset( $var5, $var7 );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$text .= ')
    ...
    ';
// undef $rating
$tpl->unsetLocalVariable( 'rating', $rootNamespace );

$text .= '  </div>
<div class="float-break"></div>
</div>';

$setArray = $oldSetArray_7b09bd28ace3d336162dbacf53eff62b;
$tpl->Level--;
?>
