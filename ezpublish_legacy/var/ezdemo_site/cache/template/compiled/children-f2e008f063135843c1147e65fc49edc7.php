...
$oldSetArray_e19b6644257a8cf639a7d8e3bddd07d0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="children" method="post" action="/ezpublish/index.php/admin_site/content/action">
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var = $var1 ? $var3 : '"/ezpublish/index.php/admin_site"';
unset( $var1, $var3 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$text .= ' title="Up one level."><img src="/ezpublish/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Up one level." title="Up one level." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '
    ...
    ';
$oldRestoreIncludeArray_9349ad2c7d671187278acfa44b78ee7e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children_detailed-b0fd0799bdf7657ff8e5bf62881aed24.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/children_detailed-b0fd0799bdf7657ff8e5bf62881aed24.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_9349ad2c7d671187278acfa44b78ee7e;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_0ba7d5d782639a9a0b4b2875ea950192 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/alphabetical-9a93c864cd6b0e13c11771ad8d7fb76c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/alphabetical-9a93c864cd6b0e13c11771ad8d7fb76c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0ba7d5d782639a9a0b4b2875ea950192;
...
$setArray = $oldSetArray_e19b6644257a8cf639a7d8e3bddd07d0;
$tpl->Level--;
?>
