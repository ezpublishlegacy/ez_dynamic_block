...
$oldSetArray_57442a27e381925788d5fc6de30591ad = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="clearcacheform" method="post" action="/ezpublish/index.php/admin_site/setup/cache">
...
<tr>
    <th class="tight"><img src="/ezpublish/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." onclick="ezjs_toggleCheckboxes( document.clearcacheform, \'CacheList[]\' ); return false;" title="Invert selection." /></th>
    <th>Name</th>
    <th>Path</th>
</tr>';
unset( $loopItem );
...
$setArray = $oldSetArray_57442a27e381925788d5fc6de30591ad;
$tpl->Level--;
?>
