...
// Timestamp: 1396700317 (Sat Apr 5 5:18:37 PDT 2014)
$oldSetArray_341be9e5d4389c058dfbcfdea101dbdf = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-child-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'edit-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/edit/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'delete-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/delete/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'merge-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/merge/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-synonym-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/addsynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'make-synonym-tag\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/makesynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '    menuArray[\'TagMenuSimple\'] = { \'depth\': 0, \'headerID\': \'tag-simple-header\' };
    ...
    menuArray[\'TagMenuSimple\'][\'elements\'][\'add-child-tag-simple\'] = { \'url\': "/ezpublish/index.php/admin_site/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="add-child-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Add child tag</a>
    ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="edit-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Edit tag</a>
    ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="delete-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Delete tag</a>
    ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="merge-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Merge tag</a>
    ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="add-synonym-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Add synonym</a>
    ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="make-synonym-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Convert to synonym</a>
    ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_341be9e5d4389c058dfbcfdea101dbdf;
$tpl->Level--;
?>
