...
$oldSetArray_2c7f72535ab5535cff283afc416bac8c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "47_0_47_194_design/admin/templates/pagelayout.tpl", "admin_site" );
...
$textStack[] = $text;
$text = '';
$oldRestoreIncludeArray_de5550efd145c4ef9dc77beaa87b7fc6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-a4aa62d21bee53dd2f80ae5151940f4c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-a4aa62d21bee53dd2f80ae5151940f4c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_de5550efd145c4ef9dc77beaa87b7fc6;

$oldRestoreIncludeArray_263ae0b008289efe0ca07b8afa4aa254 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-6b532998dcd7393a71d3ac66baebcee3.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-6b532998dcd7393a71d3ac66baebcee3.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_263ae0b008289efe0ca07b8afa4aa254;

$oldRestoreIncludeArray_d49eded2ea6c6d5cd6954b5b464c51e2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-fe1cbecafcbcc01a13df55f4d8dd732e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-fe1cbecafcbcc01a13df55f4d8dd732e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_d49eded2ea6c6d5cd6954b5b464c51e2;
...
';
$oldRestoreIncludeArray_f784bfd4afea069cc3278c3883191beb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_header-7307a8f957a6b4fde65f626f3b30f09c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_header-7307a8f957a6b4fde65f626f3b30f09c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f784bfd4afea069cc3278c3883191beb;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "66_0_66_174_design/admin/templates/pagelayout.tpl", "admin_site" );
...
$text .= '
';
$oldRestoreIncludeArray_c61d9ef46ccca859eb1bb5e1d3a7636c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenu-c0a60faa8a9b1f08e9dd6f6158f14761.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenu-c0a60faa8a9b1f08e9dd6f6158f14761.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_c61d9ef46ccca859eb1bb5e1d3a7636c;
...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Show / Hide rightmenu" href="/ezpublish/index.php/admin_site/user/preferences/set/admin_right_menu_show/1"></a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Hide / Show rightmenu" href="/ezpublish/index.php/admin_site/user/preferences/set/admin_right_menu_show/0"></a>
    <div id="rightmenu-design">
        ';
$oldRestoreIncludeArray_67ea5ae3c7cb86b97a78118c56642462 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_current_user-bbdf628928da1cc536efb07e9b41fb5d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_current_user-bbdf628928da1cc536efb07e9b41fb5d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_67ea5ae3c7cb86b97a78118c56642462;

$oldRestoreIncludeArray_cf593ce3ee0fabc52006236bc4acf1b0 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_preferences-aa483e8e645ada79c23e16134d848f1c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_preferences-aa483e8e645ada79c23e16134d848f1c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_cf593ce3ee0fabc52006236bc4acf1b0;

$oldRestoreIncludeArray_17c07a92d79ff50d252ed9772c26db4d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-674b70df1170a133f2b04b07a508ed8b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-674b70df1170a133f2b04b07a508ed8b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_17c07a92d79ff50d252ed9772c26db4d;

$text .= '        ';
$oldRestoreIncludeArray_5f11bc17a4bdb57afc40b05bdb475106 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-59129e9c5cf5de0a62354409b96b5afc.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-59129e9c5cf5de0a62354409b96b5afc.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_5f11bc17a4bdb57afc40b05bdb475106;

$oldRestoreIncludeArray_a7fd7d0c42d2f937444fd6e4e5fb0b21 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-28dc5bb1d34f4b847ee519bed99aa018.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-28dc5bb1d34f4b847ee519bed99aa018.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_a7fd7d0c42d2f937444fd6e4e5fb0b21;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "148_0_148_161_design/admin/templates/pagelayout.tpl", "admin_site" );
...
{
$text .= '    ';
$oldRestoreIncludeArray_da0cab599e24ba66a90bcdeaf91a16fd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_leftmenu-d5cd66c626b78574b970b4d9784df1c9.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_leftmenu-d5cd66c626b78574b970b4d9784df1c9.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_da0cab599e24ba66a90bcdeaf91a16fd;
...
{
$text .= '    ';
$oldRestoreIncludeArray_e12e138e8d29e5caacbc2a5f8996fe18 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-c63760c009e90522b8b9ef1b5807aebc.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-c63760c009e90522b8b9ef1b5807aebc.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e12e138e8d29e5caacbc2a5f8996fe18;
...
$text .= '    <div id="maincontent">
    ...
    <div id="path">
        <div id="path-design">
            ';
$oldRestoreIncludeArray_88519a8f75d5b76a47fb74ccf5cf8c35 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_toppath-e04c129310139edc22e41e54c258059a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_toppath-e04c129310139edc22e41e54c258059a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_88519a8f75d5b76a47fb74ccf5cf8c35;
...
$text .= '        </div>
    ...
    <!-- Maincontent START -->
    ';
$oldRestoreIncludeArray_6352058f6e7d5d8d4a830220804f3b07 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_6352058f6e7d5d8d4a830220804f3b07;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "191_0_191_60_design/admin/templates/pagelayout.tpl", "admin_site" );
...
<div id="footer-design">
    ';
$oldRestoreIncludeArray_aa97faf55929582db3429e5d05ef2dea = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_copyright-c5f9cdf30e6cacf59ec003c1b839635a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_copyright-c5f9cdf30e6cacf59ec003c1b839635a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_aa97faf55929582db3429e5d05ef2dea;
...
';
$oldRestoreIncludeArray_7caddfbf534248120871fffb200db930 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/popup_menu-f97d8df56fba76b13f5f4923621ae7d6.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/popup_menu-f97d8df56fba76b13f5f4923621ae7d6.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7caddfbf534248120871fffb200db930;
...
<img src="/ezpublish/design/admin/images/2/loader.gif" id="ajaxuploader-loader" style="display:none;" alt="Loading..." />
...
$setArray = $oldSetArray_2c7f72535ab5535cff283afc416bac8c;
$tpl->Level--;
?>
