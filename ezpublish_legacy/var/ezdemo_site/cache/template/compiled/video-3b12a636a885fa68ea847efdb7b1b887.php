...
$oldSetArray_cacfa31b65963165a539acc1b0dcadf5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<script>
    _V_.options.flash.swf = "/ezpublish/extension/ezdemo/design/ezdemo/flash/video-js.swf"
</script>
...
$setArray = $oldSetArray_cacfa31b65963165a539acc1b0dcadf5;
$tpl->Level--;
?>
