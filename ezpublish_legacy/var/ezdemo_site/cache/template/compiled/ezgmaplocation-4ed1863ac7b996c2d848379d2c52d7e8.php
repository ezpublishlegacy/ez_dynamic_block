<?php
// URI:       design:content/datatype/edit/ezgmaplocation.tpl
// Filename:  extension/ezgmaplocation/design/standard/templates/content/datatype/edit/ezgmaplocation.tpl
// Timestamp: 1404662619 (Sun Jul 6 9:03:39 PDT 2014)
$oldSetArray_95119086f7511158a17dcf66f5af554b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_base', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_base'] : null;
...
if ( $tpl->hasVariable( 'attribute_base', $rootNamespace ) )
{
  ...
  2 => 'extension/ezgmaplocation/design/standard/templates/content/datatype/edit/ezgmaplocation.tpl',
) );
...
<div class="element">';
if ( !isset( $GLOBALS['eZTemplateRunOnceKeys']["9db7182bc58b7112480fe8d2673cef59"] ) )
{
    $GLOBALS['eZTemplateRunOnceKeys']["9db7182bc58b7112480fe8d2673cef59"] = array( array( 11,
              0,
              390 ),
       array( 11,
              8,
              398 ),
       "extension/ezgmaplocation/design/standard/templates/content/datatype/edit/ezgmaplocation.tpl" );
...
if ( window.addEventListener )
    window.addEventListener(\'load\', function(){ eZGmapLocation_MapControl( ';
unset( $var );
unset( $var );
...
$text .= '" ) }, false);
    ...
    window.attachEvent(\'onload\', function(){ eZGmapLocation_MapControl( ';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" ) } );
    ...
    <input type="text" id="ezgml-address-';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '_data_gmaplocation_address_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '"/>
    <input class="button" type="button" id="ezgml-address-button-';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" value="Find address"/>
    <input class="button-disabled" type="button" id="ezgml-restore-button-';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" value="Restore" onclick="javascript:void( null ); return false" disabled="disabled"  title="Restores location and address values to what it was on page load." />

    <input id="ezgml_hidden_address_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" type="hidden" name="ezgml_hidden_address_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" disabled="disabled" />
    <input id="ezgml_hidden_latitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" type="hidden" name="ezgml_hidden_latitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" disabled="disabled" />
    <input id="ezgml_hidden_longitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" type="hidden" name="ezgml_hidden_longitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" style="width: 500px; height: 280px; margin-top: 2px;"></div>
</div>
...
$text .= '_data_gmaplocation_latitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '_longitude" class="box ezcc-';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'object' );
...
$text .= '_data_gmaplocation_longitude_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" />
  ...
  <div class="block">
    <input class="button-disabled" type="button" id="ezgml-mylocation-button-';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '" value="My current location" onclick="javascript:void( null ); return false" disabled="disabled" title="Gets your current position if your browser support GeoLocation and you grant this website access to it! Most accurate if you have a built in gps in your Internet device! Also note that you might still have to type in address manually!" />
  </div>
</div>
...
$setArray = $oldSetArray_95119086f7511158a17dcf66f5af554b;
$tpl->Level--;
?>
