...
$oldSetArray_888cb8c1275f38f93672d02cf72f2f12 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'ContextMenu\'][\'elements\'][\'menu-view\'] = { \'url\': "/ezpublish/index.php/admin_site/content/view/full/%nodeID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-edit\'] = { \'url\': "/ezpublish/index.php/admin_site/content/edit/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy\'] = { \'url\': "/ezpublish/index.php/admin_site/content/copy/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy-subtree\']= { \'url\': "/ezpublish/index.php/admin_site/content/copysubtree/%nodeID%" };
...
$loopItem = array (
  ...
  2 => 'node/ezfindcontextmenu.tpl',
  3 => 'node/ezmucontextmenu.tpl',
);
...
$setArray = $oldSetArray_888cb8c1275f38f93672d02cf72f2f12;
$tpl->Level--;
?>
