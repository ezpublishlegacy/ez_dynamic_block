...
$oldSetArray_96042347c8192cac82009289c3b6c96f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/ezpublish/index.php/admin_site/user/preferences/set/admin_navigation_content/1" title="Enable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/ezpublish/index.php/admin_site/user/preferences/set/admin_navigation_content/0" title="Disable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_3b8ff88e7154cd1aac4ae11e1d5abf93 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-447f9d30a60d20c511e6e7e05777cbc4.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-447f9d30a60d20c511e6e7e05777cbc4.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_3b8ff88e7154cd1aac4ae11e1d5abf93;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_dec2110bac9cd688fa69e42f9547f017 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/windows-0d4691bf51eedbc6dab9cf6678dbd094.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/windows-0d4691bf51eedbc6dab9cf6678dbd094.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_dec2110bac9cd688fa69e42f9547f017;
...
$setArray = $oldSetArray_96042347c8192cac82009289c3b6c96f;
$tpl->Level--;
?>
