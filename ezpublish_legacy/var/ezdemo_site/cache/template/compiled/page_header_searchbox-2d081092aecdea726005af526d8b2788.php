...
$oldSetArray_57b5c52c556a4ca16dda0178b1d77d50 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<form class="span4 form-search" method="get" action="/ezpublish/eng/content/search" id="site-wide-search">
...
$setArray = $oldSetArray_57b5c52c556a4ca16dda0178b1d77d50;
$tpl->Level--;
?>
