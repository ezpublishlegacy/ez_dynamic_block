...
$oldSetArray_5207d01776dc97f8e31782e0f1bbdd1d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/ezpublish/index.php/user_site/shop/basket" title="Shopping basket">Shopping basket</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/ezpublish/index.php/user_site/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/ezpublish/index.php/user_site/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/ezpublish/index.php/user_site/user/register" title="Register">Register</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/ezpublish/index.php/user_site/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/ezpublish/index.php/user_site/user/forgotpassword" class="forgot-password">Forgot your password?</a>
...
$setArray = $oldSetArray_5207d01776dc97f8e31782e0f1bbdd1d;
$tpl->Level--;
?>
