...
$oldSetArray_75a451e6bc87233da6412d8efece05d8 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
';
$oldRestoreIncludeArray_ea0cc2b51564532dd9826585aa2ad933 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/infocollection_validation-e9bad58db9fda6dd9c30a5e43a8e74fc.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/infocollection_validation-e9bad58db9fda6dd9c30a5e43a8e74fc.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_ea0cc2b51564532dd9826585aa2ad933;
...
';
$oldRestoreIncludeArray_07db5c51a64f0a648836b6a7a06893af = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls-057d8997a94725f3756e1c36367eb825.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls-057d8997a94725f3756e1c36367eb825.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_07db5c51a64f0a648836b6a7a06893af;
...
<form method="post" action="/ezpublish/index.php/admin_site/content/action">
...
{
$text .= '    ';
$oldRestoreIncludeArray_c729671465dd2c882914d739ad107304 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children-f2e008f063135843c1147e65fc49edc7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/children-f2e008f063135843c1147e65fc49edc7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_c729671465dd2c882914d739ad107304;

}
else
{
$text .= '    ';
$oldRestoreIncludeArray_e7c768394a4c9d58f535522af36ea146 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/no_children-5efc2e108ef8b05dbe323978370e2823.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/no_children-5efc2e108ef8b05dbe323978370e2823.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e7c768394a4c9d58f535522af36ea146;
...
$setArray = $oldSetArray_75a451e6bc87233da6412d8efece05d8;
$tpl->Level--;
?>
