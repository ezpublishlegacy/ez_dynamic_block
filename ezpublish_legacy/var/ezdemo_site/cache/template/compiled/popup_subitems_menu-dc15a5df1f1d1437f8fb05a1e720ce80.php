...
$oldSetArray_1e5ff8dc962a39b47da12a1fa25c9144 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-view\'] = { \'url\': "/ezpublish/index.php/admin_site/content/view/full/%nodeID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-preview\'] = { \'url\': "/ezpublish/index.php/admin_site/content/versionview/%objectID%/%version%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-edit\'] = { \'url\': "/ezpublish/index.php/admin_site/content/edit/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy\'] = { \'url\': "/ezpublish/index.php/admin_site/content/copy/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy-subtree\'] = { \'url\': "/ezpublish/index.php/admin_site/content/copysubtree/%nodeID%" };
...
$loopItem = array (
  ...
  2 => 'node/ezfindsubitemscontextmenu.tpl',
  3 => 'node/ezmusubitemscontextmenu.tpl',
);
...
$setArray = $oldSetArray_1e5ff8dc962a39b47da12a1fa25c9144;
$tpl->Level--;
?>
