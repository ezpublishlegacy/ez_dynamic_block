...
$oldSetArray_90e976c7142a298af43f050a5c18806e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<link rel="stylesheet" type="text/css" href="/ezpublish/" />';
}
unset( $if_cond );
// if ends
...
$text .= '<link rel="stylesheet" type="text/css" href="/ezpublish/extension/ezdemo/design/ezdemo/stylesheets/print.css" media="print" />
';

$setArray = $oldSetArray_90e976c7142a298af43f050a5c18806e;
$tpl->Level--;
?>
