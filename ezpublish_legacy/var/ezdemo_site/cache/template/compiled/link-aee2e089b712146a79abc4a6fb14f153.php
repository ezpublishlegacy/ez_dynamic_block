...
$oldSetArray_7498185add875e5591d5332bea3f7175 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/ezpublish/index.php/admin_site" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Top"  href="/ezpublish/index.php/admin_site" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/ezpublish/index.php/admin_site/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_7498185add875e5591d5332bea3f7175;
$tpl->Level--;
?>
