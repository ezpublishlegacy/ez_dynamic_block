...
$oldSetArray_b3d3c696d0a7400534665975db49b2d4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '  ';
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'module_result', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['module_result'] : null;
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_172 = compiledFetchAttribute( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171, 'title_path' );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_172;
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171->templateValue();
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171->templateValue();
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 = isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 );unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_171 );
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17->templateValue();
...
elseif ( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_17 )
{
$text .= '    ';
unset( $var );
unset( $var );
...
{
$text .= '    ';
$oldRestoreIncludeArray_2ffbc2948b152471688de2d78fc03396 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-fa321f08bdb709c6cb766622351552a8.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-fa321f08bdb709c6cb766622351552a8.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2ffbc2948b152471688de2d78fc03396;
...
{
$text .= '    ';
$oldRestoreIncludeArray_80973827d960ddfbdd334979d207453c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-aee2e089b712146a79abc4a6fb14f153.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-aee2e089b712146a79abc4a6fb14f153.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_80973827d960ddfbdd334979d207453c;
...
$setArray = $oldSetArray_b3d3c696d0a7400534665975db49b2d4;
$tpl->Level--;
?>
