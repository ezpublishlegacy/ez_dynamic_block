<?php
// URI:       design:content/browse.tpl
// Filename:  design/admin/templates/content/browse.tpl
// Timestamp: 1397808120 (Fri Apr 18 1:02:00 PDT 2014)
$oldSetArray_cb6c2f93e9b3907c95b7bbb3dbc326f1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$vars[$currentNamespace]['item_type'] = $var;
unset( $var );
unset( $var );
unset( $var1 );
unset( $var2 );
...
unset( $var );
$vars[$currentNamespace]['select_name'] = 'SelectedObjectIDArray';
$vars[$currentNamespace]['select_type'] = 'checkbox';
$vars[$currentNamespace]['select_attribute'] = 'contentobject_id';
$vars[$currentNamespace]['browse_list_count'] = 0;
$vars[$currentNamespace]['page_uri_suffix'] = false;
$vars[$currentNamespace]['node_array'] = array (
);
unset( $var );
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_list', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_list'] : null;
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'requested_uri', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['requested_uri'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( $tpl->hasVariable( 'page_uri', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'page_uri' is already defined.", array (
  0 => 
  array (
    0 => 11,
    1 => 4,
  ...
  2 => 'design/admin/templates/content/browse.tpl',
) );
    $tpl->setVariable( 'page_uri', $var, $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'page_uri', $var, $rootNamespace );
}

$text .= '    ';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_list_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_list_count'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'browse_list_count', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['browse_list_count'] = $var;
    unset( $var );
}
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_list', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_list'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'node_array', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['node_array'] = $var;
    unset( $var );
}
unset( $var );
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'requested_uri_suffix', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['requested_uri_suffix'] : null;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'page_uri_suffix', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['page_uri_suffix'] = $var;
    unset( $var );
}
}
else
...
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'main_node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['main_node'] : null;
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse_list_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse_list_count'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
$if_cond2 = compiledFetchAttribute( $if_cond1, 'return_type' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
$if_cond = ( ( $if_cond1 ) == ( 'NodeID' ) );
unset( $if_cond1 );
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
{
$text .= '    ';
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'select_name', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['select_name'] = 'SelectedNodeIDArray';
}
$text .= '    ';
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'select_attribute', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['select_attribute'] = 'node_id';
}
}
unset( $if_cond );
// if ends
...
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'selection' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
$if_cond = ( ( $if_cond1 ) == ( 'single' ) );
unset( $if_cond1 );
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
{
$text .= '    ';
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'select_type', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['select_type'] = 'radio';
}
}
unset( $if_cond );
// if ends
...
$if_cond1 = compiledFetchAttribute( $if_cond, 'description_template' );
unset( $if_cond );
$if_cond = $if_cond1;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
<h1 class="context-title">Browse</h1>
...
<p>To select objects, choose the appropriate radio button or checkbox(es), then click the "Select" button.</p>
<p>To select an object that is a child of one of the displayed objects, click the object name for a list of the children of the object.</p>
...
$var2 = compiledFetchAttribute( $var1, 'from_page' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $show2 );
unset( $show2 );
$show2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$show3 = compiledFetchAttribute( $show2, 'action_name' );
unset( $show2 );
$show2 = $show3;
...
unset( $show3 );
unset( $show3 );
$show3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$show4 = compiledFetchAttribute( $show3, 'action_name' );
unset( $show3 );
$show3 = $show4;
...
while ( is_object( $show3 ) and method_exists( $show3, 'templateValue' ) )
    $show3 = $show3->templateValue();
$show2 = ( ( $show3 ) == ( 'SelectLinkObjectID' ) );
unset( $show3 );
if (! isset( $show2 ) ) $show2 = NULL;
while ( is_object( $show2 ) and method_exists( $show2, 'templateValue' ) )
    $show2 = $show2->templateValue();
...
unset( $show4 );
unset( $show4 );
$show4 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$show5 = compiledFetchAttribute( $show4, 'action_name' );
unset( $show4 );
$show4 = $show5;
...
while ( is_object( $show4 ) and method_exists( $show4, 'templateValue' ) )
    $show4 = $show4->templateValue();
$show3 = ( ( $show4 ) == ( 'AddRelatedObjectToOE' ) );
unset( $show4 );
if (! isset( $show3 ) ) $show3 = NULL;
while ( is_object( $show3 ) and method_exists( $show3, 'templateValue' ) )
    $show3 = $show3->templateValue();
...
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'bookmark_list', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['bookmark_list'] : null;
if (! isset( $show ) ) $show = NULL;
while ( is_object( $show ) and method_exists( $show, 'templateValue' ) )
    $show = $show->templateValue();
...
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$if_cond3 = compiledFetchAttribute( $if_cond2, 'ignore_nodes_select' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
...
unset( $if_cond2 );
$if_cond2 = $if_cond3;
$if_cond3 = compiledFetchAttribute( $if_cond2, 'node' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
...
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$if_cond3 = compiledFetchAttribute( $if_cond2, 'ignore_nodes_click' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Nodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Nodes'] : null;
$if_cond1 = compiledFetchAttribute( $if_cond, 'item' );
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'node' );
unset( $if_cond );
$if_cond = $if_cond1;
...
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$var2 = compiledFetchAttribute( $var1, 'start_node' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$vars[$currentNamespace]['current_node'] = $var;
unset( $var );
$text .= '    ';
// if begins
unset( $if_cond );
...
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'start_node' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
...
if ( $if_cond )
{
$text .= '        <h2 class="context-title">
        <a href=';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var3 );
$var3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'main_node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['main_node'] : null;
$var4 = compiledFetchAttribute( $var3, 'parent_node_id' );
unset( $var3 );
$var3 = $var4;
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
...
$text .= '><img src="/ezpublish/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Back" /></a>
        ';
unset( $var );
unset( $var );
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse_list_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse_list_count'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$text .= ( is_object( $var ) ? compiledFetchText( $tpl, $rootNamespace, $currentNamespace, false, $var ) : $var );
...
{
$text .= '    <h2 class="context-title"><img src="/ezpublish/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Back" /> ';
unset( $var );
$var = 'folder';
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
...
$text .= '    ';
unset( $vars[$currentNamespace]['current_node'] );
}
else
{
$text .= ' <h2 class="context-title"><img src="/ezpublish/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Back" /> ';
...
switch ( $match )
{
    case 25:
    {
$text .= '        <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_list_limit/1">10</a>
        <span class="current">25</span>
        <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_list_limit/3">50</a>
    ...
    {
$text .= '        <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_list_limit/1">10</a>
        <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_list_limit/2">25</a>
...
$text .= '<div class="button-right">
    ...
    ';
unset( $var );
$var = eZPreferences::value( "admin_children_browsemode" );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$vars[$currentNamespace]['match'] = $var;
unset( $var );
unset( $match );
$match = eZPreferences::value( "admin_children_browsemode" );
if (! isset( $match ) ) $match = NULL;
while ( is_object( $match ) and method_exists( $match, 'templateValue' ) )
    $match = $match->templateValue();
...
switch ( $match )
{
    case "thumbnail":
    {
$text .= '      <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_children_browsemode/list" title="Display sub items using a simple list.">List</a>
      <span class="current">Thumbnail</span>
    ';
    } break;
    default:
    {
$text .= '      <span class="current">List</span>
      <a href="/ezpublish/index.php/admin_site/user/preferences/set/admin_children_browsemode/thumbnail" title="Display sub items as thumbnails.">Thumbnail</a>
    ';
    } break;
}
unset( $match );
...
';
$oldRestoreIncludeArray_36ebd5665528b0df55f0b16059b649b9 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
unset( $var );
if ( isset( $namespace ) and isset( $vars[$namespace]['show_google_navigator'] ) )
    $restoreIncludeArray[] = array( $namespace, 'show_google_navigator', $vars[$namespace]['show_google_navigator'] );
elseif ( !isset( $vars[( isset( $namespace ) ? $namespace : '' )]['show_google_navigator'] ) ) 
    $restoreIncludeArray[] = array( ( isset( $namespace ) ? $namespace : '' ), 'show_google_navigator', 'unset' );
...
if ( $namespace == '' )
    ...
    $namespace .= ':navigator';
$vars[$namespace]['show_google_navigator'] = true;
if ( !isset( $dKeys ) )
{
...
$restoreIncludeArray = $oldRestoreIncludeArray_36ebd5665528b0df55f0b16059b649b9;
...
switch ( $match )
{
    ...
    {
$text .= '        ';
$oldRestoreIncludeArray_530ca7206fb555f39871f2ec58c5342d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/browse_mode_thumbnail-c8c5c82c6e1c9090919b4f9f4838d7db.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin/templates/content/browse_mode_thumbnail.tpl' );
include( '' . 'var/ezdemo_site/cache/template/compiled/browse_mode_thumbnail-c8c5c82c6e1c9090919b4f9f4838d7db.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin/templates/content/browse_mode_thumbnail.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_530ca7206fb555f39871f2ec58c5342d;
...
$text .= '    ';
    ...
    {
$text .= '        ';
$oldRestoreIncludeArray_6935bdb9983b5278fc0936fda1553482 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/browse_mode_list-bfda290ed4c8330b363cf1223ac74d47.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin/templates/content/browse_mode_list.tpl' );
include( '' . 'var/ezdemo_site/cache/template/compiled/browse_mode_list-bfda290ed4c8330b363cf1223ac74d47.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin/templates/content/browse_mode_list.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_6935bdb9983b5278fc0936fda1553482;
...
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$show1 = compiledFetchAttribute( $show, 'persistent_data' );
unset( $show );
$show = $show1;
if (! isset( $show ) ) $show = NULL;
while ( is_object( $show ) and method_exists( $show, 'templateValue' ) )
...
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$loopItem1 = compiledFetchAttribute( $loopItem, 'persistent_data' );
unset( $loopItem );
$loopItem = $loopItem1;
if (! isset( $loopItem ) ) $loopItem = NULL;
while ( is_object( $loopItem ) and method_exists( $loopItem, 'templateValue' ) )
...
while ( $index < $loopCount )
{
    ...
    $variableValue->setIteratorValues( $item, $loopKey, $currentIndex - 1, $currentIndex, false, $last );
$vars[$currentNamespace]['PersistentData'] = $variableValue;
$sectionStack[] = array( &$variableValue, &$loopItem, $loopKeys, $loopCount, $currentIndex, $index );
unset( $loopItem, $loopKeys );
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'PersistentData', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['PersistentData'] : null;
...
$text .= '
<input type="hidden" name="BrowseActionName" value="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$var1 = compiledFetchAttribute( $var, 'action_name' );
unset( $var );
$var = $var1;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
...
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$if_cond1 = compiledFetchAttribute( $if_cond, 'browse_custom_action' );
unset( $if_cond );
$if_cond = $if_cond1;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'browse', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['browse'] : null;
$var1 = compiledFetchAttribute( $var, 'browse_custom_action' );
unset( $var );
$var = $var1;
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'cancel_action', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['cancel_action'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
if ( $if_cond )
{
$text .= '<input type="hidden" name="BrowseCancelURI" value="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'cancel_action', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['cancel_action'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
<div class="block">
    ...
    <input class="button" type="submit" name="BrowseCancelButton" value="Cancel" />
</div>
</div></div>
</div>
...
';
unset( $vars[$currentNamespace]['item_type'] );
unset( $vars[$currentNamespace]['number_of_items'] );
unset( $vars[$currentNamespace]['select_name'] );
unset( $vars[$currentNamespace]['select_type'] );
unset( $vars[$currentNamespace]['select_attribute'] );
unset( $vars[$currentNamespace]['browse_list_count'] );
unset( $vars[$currentNamespace]['page_uri_suffix'] );
unset( $vars[$currentNamespace]['node_array'] );
unset( $vars[$currentNamespace]['bookmark_list'] );

$setArray = $oldSetArray_cb6c2f93e9b3907c95b7bbb3dbc326f1;
$tpl->Level--;
?>
