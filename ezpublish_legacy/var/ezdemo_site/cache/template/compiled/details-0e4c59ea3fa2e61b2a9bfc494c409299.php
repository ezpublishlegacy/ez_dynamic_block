...
$oldSetArray_6c16b9cf9e25170c8b0f111fe386c266 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="statesform" method="post" action="/ezpublish/index.php/admin_site/state/assign">
...
unset( $var2 );
unset( $var3 );
$var3 = ( '<a href=' . '"/ezpublish/index.php/admin_site/state/groups"' . '>' );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$setArray = $oldSetArray_6c16b9cf9e25170c8b0f111fe386c266;
$tpl->Level--;
?>
