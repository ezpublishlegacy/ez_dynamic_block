...
$oldSetArray_d30c93811df7c90f515cd40f6ce9635b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'EditClassSubmenu\'][\'elements\'][\'edit-class-languages\'][\'content\'] = \'<a href="/ezpublish/index.php/admin_site/class/edit/%classID%/(language)/%locale%" onmouseover="ezpopmenu_mouseOver( \\\'EditClassSubmenu\\\' )">%name%<\\/a>\';
menuArray[\'EditClassSubmenu\'][\'elements\'][\'edit-class-another-language\'] = { \'url\': "/ezpublish/index.php/admin_site/class/edit/%classID%" };
...
$setArray = $oldSetArray_d30c93811df7c90f515cd40f6ce9635b;
$tpl->Level--;
?>
