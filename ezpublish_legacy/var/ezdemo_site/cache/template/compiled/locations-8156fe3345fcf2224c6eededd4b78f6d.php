...
$oldSetArray_6745c721071fff98a317e223d1d2e525 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form name="locationsform" method="post" action="/ezpublish/index.php/admin_site/content/action">
...
<tr>
    <th class="tight"><img src="/ezpublish/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.locationsform, \'LocationIDSelection[]\' ); return false;"/></th>
...
$setArray = $oldSetArray_6745c721071fff98a317e223d1d2e525;
$tpl->Level--;
?>
