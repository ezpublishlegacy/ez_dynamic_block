...
$oldSetArray_d4c5deb2c633184f9491a5e6c25a05de = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var2 = array( '%edition' => $var3, '%about_link' => "\"/ezpublish/index.php/admin_site/ezinfo/about\"" );unset( $var3 );
...
$setArray = $oldSetArray_d4c5deb2c633184f9491a5e6c25a05de;
$tpl->Level--;
?>
